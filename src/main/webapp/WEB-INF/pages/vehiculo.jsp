						...
						<form id="frmSearch" class="form-horizontal ">
							...
							<div class="form-group">
								...
								<div class=" col-md-4 col-sm-4 col-xs-12">
									<input class="form-control text-uppercase" type="text" id="placaS" name="placaS">
								</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="frmVehiculo" name ="frmItem" method="post" data-parsley-validate
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<div class=" col-md-4 col-sm-4 col-xs-12">
									<input class="form-control text-uppercase" type="text" id="placa" name="placa">
								</div>								
							</div>
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Marca:</label>
								<div class=" col-md-7 col-sm-7 col-xs-12">
									<input class="form-control text-uppercase" type="text" id="marca" name="marca">
								</div>
							</div>
						</div>
					</div>
...
<script src="<c:url value="/resources/app/vehiculo.js" />" type="text/javascript"></script>
</html>