	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="frmDestino" name ="frmItem" method="post" data-parsley-validate
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-group">
								...
								<div class=" col-md-4 col-sm-4 col-xs-12">
									<input class="form-control text-uppercase" type="text" id="codigo" name="codigo">
								</div>								
							</div>
							<div class="form-group">
...
<script src="<c:url value="/resources/app/destino.js" />" type="text/javascript"></script>
</html>